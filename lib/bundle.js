(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("assert"), require("date-now"), require("util"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "assert", "date-now", "util"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("react"), require("assert"), require("date-now"), require("util")) : factory(root["react"], root["assert"], root["date-now"], root["util"]);
...
var _Case = __webpack_require__(0);
